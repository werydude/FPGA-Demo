...
REM
REM Generated by Vivado on Thu May 08 19:41:08 -0700 2025
...
echo "xvlog --incr --relax -prj SevenSegment_Hex_vlog.prj"
call xvlog  --incr --relax -prj SevenSegment_Hex_vlog.prj -log xvlog.log
